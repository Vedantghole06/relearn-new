    ...
    <div className="min-h-min bg-gray-50 p-4 md:p-6">
        ...
        <div className="mt-8 text-center">
            <p className="text-lg text-gray-700 mb-4">
                Let's get started by creating your first library question, block, template or collection. Click the New button
                to create it.
            </p>
            <p className="text-sm text-gray-600 italic">
                Advanced users: You can also drag and drop XLSForms here and they will be uploaded and converted to library
                items.
            </p>
        </div>
    </div>
