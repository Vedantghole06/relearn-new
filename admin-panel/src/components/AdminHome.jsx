...
import { Menu, X, User, FormInput, Users2Icon, BookTemplate, DatabaseIcon, DatabaseZapIcon } from "lucide-react";
    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      >
        ...
        <nav className="mt-4 px-4">
          <ul>
            <li
              className={`mb-4 flex items-center cursor-pointer p-2 rounded-lg ${activeContent === "profile"
            ...
            <li
              className={`mb-4 flex items-center cursor-pointer p-2 rounded-lg ${activeContent === "user"
                  ? "bg-blue-500 text-white"
                  : "text-gray-600 hover:bg-gray-100"
                }`}
            ...
            <li
              className={`mb-4 flex items-center cursor-pointer p-2 rounded-lg ${activeContent === "create-form"
                  ? "bg-blue-500 text-white"
                  : "text-gray-600 hover:bg-gray-100"
                }`}
            ...
            <li
              className={`mb-4 flex items-center cursor-pointer p-2 rounded-lg ${activeContent === "templates"
                  ? "bg-blue-500 text-white"
                  : "text-gray-600 hover:bg-gray-100"
                }`}
            ...
            <li
              className={`mb-4 flex items-center cursor-pointer p-2 rounded-lg ${activeContent === "form-data"
                  ? "bg-blue-500 text-white"
                  : "text-gray-600 hover:bg-gray-100"
                }`}
            ...
            <li
              className={`mb-4 flex items-center cursor-pointer p-2 rounded-lg ${activeContent === "users-form-data"
                  ? "bg-blue-500 text-white"
                  : "text-gray-600 hover:bg-gray-100"
                }`}
